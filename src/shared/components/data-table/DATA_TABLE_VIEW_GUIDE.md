AQUI ES DONDE SE ARMA UN DATA-TABLE QUE POR DENTRO USA UN TableHeader (nativo de shadcn dentro de table.tsx) Y SE LE ESTABLECE UN ESTILO PERSONALIZADO, PERO TODO DENTRO DEL COMPONENTE DATA-TABLE-VIEW.TSX, POR LO CUAL NO ALTERA NI LO NATIVOS DE SHADCN NI LOS COMPONENTES QUE LO USAN (LOS QUE LLAMAN AL DATA-TABLE-VIEW.TSX) TAMPOCO NECESITAN SABER DE ESTA IMPLEMENTACION.
