...
import { AlertCircle, ArrowLeft, ImageIcon, MapPin, Package, Ruler } from "lucide-react"
...
const textareaClass =
    "w-full min-h-[80px] rounded-md border border-slate-300 bg-background px-3 py-2 text-sm " +
    "transition-colors hover:border-primary/60 focus-visible:outline-none " +
        ...
        <div className="flex-1 w-full h-full px-4 md:px-6 py-2 md:py-4 overflow-y-auto">
            <Card className="w-full max-w-4xl mx-auto shadow-lg shadow-primary/5 border border-slate-300 overflow-hidden pt-0 pb-0 gap-0 animate-fade-in-up">
                <CardHeader className="bg-primary/90 text-primary-foreground px-6 py-4 flex flex-row items-center gap-3">
                    ...
                    <div>
                        <CardTitle className="text-xl font-bold">Registro de Paquete</CardTitle>
                        <p className="text-sm text-primary-foreground/70 mt-0.5">Complete todos los campos para registrar un nuevo paquete.</p>
                    </div>
                </CardHeader>
                        ...
                        <div className="animate-fade-in-up" style={{ animationDelay: "0.05s" }}>
                            <FormSection title="Identificación del Paquete" icon={Package} className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                                ...
                                <FormField label="Tipo de Paquete" htmlFor="pf-tipo" error={errors.tipoPaquete} labelSize="sm">
                                    <Select value={fields.tipoPaquete} onValueChange={set("tipoPaquete")}>
                                        <SelectTrigger id="pf-tipo" className="w-full h-9 border-slate-300 hover:border-primary/60 focus:border-primary focus:ring-primary/20">
                                ...
                                <FormField label="Categoría" htmlFor="pf-categoria" error={errors.categoria} labelSize="sm">
                                    <Select value={fields.categoria} onValueChange={set("categoria")}>
                                        <SelectTrigger id="pf-categoria" className="w-full h-9 border-slate-300 hover:border-primary/60 focus:border-primary focus:ring-primary/20">
                ...
                <CardFooter className="flex items-center justify-between gap-3 pt-6 pb-6 border-t mt-8 bg-muted/20">
                    ...
                    <div className="flex gap-3">
                        ...
                        <AppButton type="submit" form="package-form" className="shadow-lg shadow-primary/20 min-w-[140px]">
                            Registrar Paquete
                        </AppButton>
                    </div>
                </CardFooter>
